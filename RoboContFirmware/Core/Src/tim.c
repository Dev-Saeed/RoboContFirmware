...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  {
  /* USER CODE BEGIN TIM19_MspPostInit 0 */

  /* USER CODE END TIM19_MspPostInit 0 */
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM13_MspDeInit 0 */
    ...
    PC4     ------> TIM13_CH1
    */
    HAL_GPIO_DeInit(encoder1_A_GPIO_Port, encoder1_A_Pin);
  ...
  /* USER CODE END TIM15_MspDeInit 0 */
    ...
    PB14     ------> TIM15_CH1
    */
    HAL_GPIO_DeInit(encoder4_A_GPIO_Port, encoder4_A_Pin);
...
void HAL_TIM_IC_MspDeInit(TIM_HandleTypeDef* tim_icHandle)
{
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PB1     ------> TIM3_CH4
    */
    HAL_GPIO_DeInit(GPIOB, encoder2_A_Pin|encoder3_A_Pin);
